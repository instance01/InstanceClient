...
public class EntityPlayerSP extends AbstractClientPlayer {
	...
	/**
	 * Used to tell if the player pressed forward twice. If this is at 0 and it's pressed (And they
	 * are allowed to sprint, aka enough food on the ground etc) it sets this to 7. If it's pressed
	 * and it's greater than 0 enable sprinting.
	 */
	...
	public void func_175161_p() {
		// TODO t
		if (InstanceMain.getInstance().freecam) {
			return;
		}
	 ...
	 * the user. Used for typical output (like
	 * "you asked for whether or not this game rule is set, so here's your answer"), warnings (like
	 * "I fetched this block for you by ID, but I'd like you to know that every time you do this, I
	 * die a little inside"), and errors (like "it's not called iron_pixacke, silly").
	 */
