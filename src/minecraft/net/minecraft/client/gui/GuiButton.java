...
public class GuiButton extends Gui {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY) {
		if (this.visible) {
			...
			this.drawTexturedModalRect(this.xPosition + x, this.yPosition + y, 0, 46 + var5 * 20 + y, (this.width - width_) / 2, this.height - height_);
			this.drawTexturedModalRect(this.xPosition + x + (this.width - width_) / 2, this.yPosition + y, 200 - (this.width - width_) / 2, 46 + var5 * 20 + y, (this.width - width_) / 2, this.height - height_);
